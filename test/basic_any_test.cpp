...
namespace any_tests // test definitions
{
    ...
    {
        std::string text = "test message";
        basic_any<> original = text, copy = original;
    ...
    {
        std::string text = "test message";
        basic_any<> original = text, copy;
        basic_any<> * assign_result = &(copy = original);
    ...
    void test_converting_assign()
    {
        std::string text = "test message";
        basic_any<> value;
        basic_any<> * assign_result = &(value = text);
    ...
    void test_swap()
    {
        ...
        basic_any<> copy1 = copy_counter();
        basic_any<> copy2 = copy_counter();
    ...
    void test_null_copying()
    {
        const basic_any<> null;
        basic_any<> copied = null, assigned;
        assigned = null;
