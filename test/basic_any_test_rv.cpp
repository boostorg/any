...
namespace any_tests // test definitions
{
    ...
    void test_move_construction()
    {
        basic_any<> value0 = move_copy_conting_class();
        move_copy_conting_class::copy_count = 0; 
        move_copy_conting_class::moves_count = 0;
        basic_any<> value(boost::move(value0));
        ...
        check_non_null(basic_any_cast<move_copy_conting_class>(&value), "any_cast<move_copy_conting_class>");
        check_equal(
    ...
    {
        basic_any<> value0 = move_copy_conting_class();
        basic_any<> value = move_copy_conting_class();
        move_copy_conting_class::copy_count = 0; 
        move_copy_conting_class::moves_count = 0;
    ...
    void test_construction_from_const_any_rv()
    {
        basic_any<> values[] = {helper_method(), helper_method1() };
        (void)values;
    }
    ...
    void test_cast_to_rv()
    {
        ...
        move_copy_conting_class value1 = basic_any_cast<move_copy_conting_class&&>(value);
...
// Following code shall fail to compile
        const basic_any<> cvalue = value0;
        move_copy_conting_class::copy_count = 0; 
        move_copy_conting_class::moves_count = 0;

        move_copy_conting_class value2 = basic_any_cast<const move_copy_conting_class&>(cvalue);
